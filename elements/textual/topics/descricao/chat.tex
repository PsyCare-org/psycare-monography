...
A página possui o menu lateral esquerdo, onde é possível pesquisar (seja por nome ou mensagem) e selecionar o chat desejado. Ao selecionar um dos itens no menu, o chat respectivo passa a ser apresentado, possibilitando a troca de mensagens em tempo real através do protocolo \textit{WebSocket}, consumido e abstraído através da biblioteca \textit{Socket.IO}. A \refImage{chat} demonstra essa tela.
