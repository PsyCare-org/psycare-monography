...
Estando autenticado na plataforma, e sendo um usuário, ao utilizar botão "Profissionais" do cabeçalho, torna-se possível chegar à tela questão. Ela permite com que os usuários possam visualizar e pesquisar os profissionais cadastrados e validados pela plataforma, conforme demonstra a \refImage{professionals}:
