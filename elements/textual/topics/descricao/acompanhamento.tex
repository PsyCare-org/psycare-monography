...
Para o paciente, além da listagem, a única ação disponível é a "Concluir afazer", que está disponível apenas nos afazeres do tipo "Normal". A \refImage{attendanceFollowUpFinish} demonstra um exemplo desse fluxo.
...
Para criar um novo encontro, a plataforma disponibiliza o botão "Criar encontro" no topo da subseção, que por sua vez abre uma janela de diálogo onde o profissional informa os dados necessários para o cadastro. Juntamente a isso, embaixo de cada registro de encontro também há a possibilidade de editar e excluir o item em questão. A \refImage{attendanceMeetingCRUD} exemplifica esses três fluxos.
